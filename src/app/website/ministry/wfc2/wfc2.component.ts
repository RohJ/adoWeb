...
@Component({
  selector: 'app-wfc2',
  templateUrl: './wfc2.component.html',
  styleUrls: ['./wfc2.component.scss']
})
export class Wfc2Component implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngOnInit() {
    ...
    .subscribe({
      ...
      for (let j = 0; j < this.createData.items.length; j++) {
        if(this.createData.items[j].summary !== 'Wholeness and Freedom Conference - Part II') {
