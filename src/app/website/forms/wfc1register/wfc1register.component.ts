...
@Component({
  selector: 'app-wfc1register',
  templateUrl: './wfc1register.component.html',
  styleUrls: ['./wfc1register.component.scss']
})
export class Wfc1registerComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  registration: Registration = {
      ...
      type: '',
      amount: '0',
      txnid: 'WFC' + Math.floor(10000000000 + Math.random() * 90000000000),
      paym: '',
      status: 'Not Paid',
      agree: false,
  };
  ...
  ngOnInit() {
    ...
    this.titleService.setTitle("Wholeness And Freedom Conference");
    this.metaTagService.updateTag({name: 'description', content: "Wholeness And Freedom Conference Registration Form"});
