...
@Component({
  selector: 'app-ewgtamilregister',
  templateUrl: './ewgtamilregister.component.html',
  styleUrls: ['./ewgtamilregister.component.scss']
})
export class EwgtamilregisterComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  hashed='';
    ...
    registration: Registration = {
        ...
        type: '',
        amount: '0',
        txnid: 'TAMILEWG' + Math.floor(10000000000 + Math.random() * 90000000000),
        paym: '',
        status: 'Not Paid',
        agree: false,
    };
    ...
    ngOnInit() {
      ...
      this.titleService.setTitle("Tamil Encounter With God");
      this.metaTagService.updateTag({name: 'description', content: "Tamil Encounter with God Registration Form"});
