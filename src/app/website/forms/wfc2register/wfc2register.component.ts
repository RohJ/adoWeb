...
@Component({
  selector: 'app-wfc2register',
  templateUrl: './wfc2register.component.html',
  styleUrls: ['./wfc2register.component.scss']
})

export class Wfc2registerComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  registration: Registration = {
      ...
      type: '',
      amount: '0',
      txnid: 'WFS' + Math.floor(10000000000 + Math.random() * 90000000000),
      paym: '',
      status: 'Not Paid',
      agree: false,
  };
